...
interface ProjectProps {
  ...
  return (
    <div className=" bg-gray-800 text-white p-10 m-6 mr-6 rounded-3xl shadow-lg max-w-md w-full transform transition duration-300 hover:scale-105 hover:shadow-2xl">
...
export default function Projects() {
  ...
  return (
    <div className="bg-gray-900 text-white flex flex-col mt-10 items-center px-6 md:px-16">
      ...
      <div className="mr-12 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 gap-10">
